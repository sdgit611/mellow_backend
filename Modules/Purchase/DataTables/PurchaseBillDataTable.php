...
class PurchaseBillDataTable extends BaseDataTable
{
    ...
    public function query(): QueryBuilder
    {
        ...
        $model = PurchaseBill::with('purchaseVendor');
    ...
    {
        return parent::setBuilder('purchasebills-table', 2)
            ->parameters([
    ...
    public function getColumns(): array
    {
        return [
            ...
            __('purchase::app.menu.vendor') => ['data' => 'vendor', 'name' => 'vendor', 'exportable' => false],
