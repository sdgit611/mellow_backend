...
class PurchaseOrderReportDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addColumn('purchase_order_count', function ($row) {
    ...
    {
        return $this->setBuilder('purchase-order-report-table')
            ->parameters([
    ...
    protected function getColumns()
    {
        return [
            ...
            __('purchase::app.menu.purchaseOrder').' '.__('purchase::modules.purchaseOrder.count') => ['data' => 'purchase_order_count', 'name' => 'purchase_order_count', 'title' => __('purchase::app.menu.purchaseOrder').' '.__('purchase::modules.purchaseOrder.count')],
