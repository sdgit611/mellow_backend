...
class PurchaseProductsDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $datatables->editColumn('stock_on_hand', function ($row) {
            ...
            {
                return $inventory->net_quantity ? $inventory->net_quantity : '--';
            }
        ...
        $customFieldColumns = CustomField::customFieldData($datatables, PurchaseProduct::CUSTOM_FIELD_MODEL);
    ...
    public function query(PurchaseProduct $model)
    {
        ...
        $model = $model->with('tax', 'category', 'subCategory', 'inventory')->join('unit_types', 'unit_types.id', '=', 'products.unit_id')
    ...
    protected function getColumns()
    {
        ...
        return array_merge($data, CustomFieldGroup::customFieldsDataMerge(new PurchaseProduct()), $action);
    }
