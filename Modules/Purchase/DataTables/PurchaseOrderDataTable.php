...
class PurchaseOrderDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                {
                    $action .= '<a class="dropdown-item" href="' . route('bills.create', $row->id) . '" >
            ...
            ->rawColumns(['delivery_status', 'action', 'purchase_order_number', 'billed_status', 'primary_name', 'total']);
    }
    ...
    public function query(PurchaseOrder $model)
    {
        ...
        if ($request->endDate !== null && $request->endDate != 'null' && $request->endDate != '') {
            ...
            $model = $model->where(DB::raw('DATE(purchase_orders.`created_at`)'), '<=', $endDate);
        }
    ...
    protected function getColumns()
    {
        $data = [
            ...
            __('app.orderNumber') => ['data' => 'purchase_order_number', 'name' => 'purchase_order_number', 'exportable' => false, 'title' => __('app.orderNumber')],
