                ...
                <div class="form-group c-inv-select mb-4">
                    ...
                    <div class="select-others height-35 rounded">
                        @if($vendorID) <input type="hidden" name="vendor_id" value="{{$vendorID}}"> @endif
                            <select @if($vendorID) disabled @endif class="form-control select-picker" name="vendor_id" id="vendor_id">
                                <option value="">--</option>
                        ...
                        <tbody>
                            ...
                            <tr class="d-none d-md-table-row d-lg-table-row">
                                ...
                                <td class="border-left-0">
                                    <input type="file" class="dropify" name="order_item_image[]"
                                        data-allowed-file-extensions="png jpg jpeg" data-height="70" />
                                    <input type="hidden" name="order_item_image_url[]">
                                </td>
                            </tr>
                        </tbody>
                    </table>
