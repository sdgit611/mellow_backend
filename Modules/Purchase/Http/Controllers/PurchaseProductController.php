...
class PurchaseProductController extends AccountBaseController
{
    ...
    public function show($id)
    {
        ...
        $this->product = PurchaseProduct::with(['category', 'subCategory'])->findOrFail($id)->withCustomFields();
    ...
    {
        $this->product = PurchaseProduct::with('orderItem.purchaseOrder.purchaseBill')->findOrFail($id)->withCustomFields();
    ...
    {
        $product = PurchaseProduct::findOrFail($id)->withCustomFields();
        $this->editPermission = user()->permission('edit_product');
