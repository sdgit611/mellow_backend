...
class VendorCreditDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->editColumn('creditDate', function ($row) {
            ...
            ->rawColumns(['action', 'check', 'prefix', 'vendor_name', 'creditDate', 'total', 'status']);
    }
    ...
    public function query(PurchaseVendorCredit $model)
    {
        ...
        $model = $model->select('purchase_vendor_credits.*',
    ...
    protected function getColumns()
    {
        return [
            ...
            __('purchase::modules.vendor.prefix') => ['data' => 'prefix', 'name' => 'prefix', 'title' => __('purchase::modules.vendor.prefix')],
            __('purchase::modules.vendor.vendor_name') => ['data' => 'vendor_name', 'name' => 'vendor_name', 'title' => __('purchase::modules.vendor.vendorName')],
            __('purchase::modules.vendor.creditDate') => ['data' => 'creditDate', 'name' => 'creditDate', 'title' => __('purchase::modules.vendor.creditDate')],
